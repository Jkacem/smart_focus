...
Sur le plan de la robustesse, l’approche hybride est plus stable dans des scénarios comportementaux variés. Le modèle entraîné, lui, montre des limites dès que les conditions d’éclairage changent ou que les objets sont partiellement masqués.
...
Le modèle 2 reste intéressant pour la détection des téléphones et pourrait compléter l’approche hybride dans une version future du système, une fois les contraintes matérielles assouplies.
